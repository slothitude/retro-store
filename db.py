...
def seed_products():
    ...
    products = [
        ...
        },
        {
            ...
            "image": "/static/images/r36-transparent.webp",
            "gallery": json.dumps(["/static/images/r36-transparent.webp"]),
            "specs": json.dumps({
                "Display": '3.5" IPS, 640x480',
                "CPU": "RK3326 Quad-Core",
                "RAM": "1GB DDR3",
        ...
        },
        {
            ...
            "price_cents": 7499,
            "compare_price_cents": 9999,
            "image": "/static/images/r36-thumb.webp",
            "gallery": json.dumps(["/static/images/r36-thumb.webp"]),
            "specs": json.dumps({
        ...
        },
        {
            ...
            "specs": json.dumps({
                ...
                "Storage": "64GB TF Card (included)",
                "Battery": "3000mAh, 6+ hours",
                "WiFi": "802.11 b/g/n (RetroMonkey upgrade)",
                "Bluetooth": "4.2 (RetroMonkey upgrade)",
